        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            >
                <ScrollView style={{
                    ...
                    <HeaderWithTitle step currentStep={'6'} totalStep={'4'} title='Configure Bot'/>
                    ...
                    <View style={styles.planInfo}>
                        ...
                        <View style={styles.planMessage}>
                            <Text style={styles.planMessageTxt}>
                                How would you like your trade to be configured?
                            </Text>
                        </View>
                    </View>
                    ...
                    <Animated.View layout={Layout.easing(Easing.bounce).delay(100)}
                        ...
                        <TouchableOpacity onPress={() => selectContinue('Auto')} activeOpacity={0.6}
                                          style={[styles.choiceBox, {
                                              borderColor: Colors.successChart,
                                              borderWidth: 1,
                                          }]}>
                            ...
                            <View style={styles.choiceBoxTop}>
                                <View style={[styles.choiceBoxIcon, {}]}>
                                    ...
                                    <MaterialCommunityIcons name="heart-settings" size={16}
                        ...
                        <TouchableOpacity onPress={() => selectContinue('Manual')} activeOpacity={0.6}
                                          style={[styles.choiceBox, {}]}>

                            <View style={styles.choiceBoxTop}>
                                <View style={styles.choiceBoxIcon}>

                                    <MaterialIcons name="settings-applications" size={16} color={"#fff"}/>
                                </View>
