...
// Merge "priceDrop" values into a single string
    ...
    const fillFromStrings = (mtRatioString, priceDropString) => {
    ...
    const exampleMtRatioString = tradeSetting.m_ratio;
    const examplePriceDropString = tradeSetting.price_drop;
