    ...
    return (
        <View style={styles.transactionCard}>
            ...
            <View style={styles.circleTop}>
                ...
                <Image
                    source={{uri: item.image !== null ? item.image : 'https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png'}}
                    style={styles.idcard}/>
...
const CircleOwner = () => {
    ...
    const {
        ...
        refetch,
        isRefetching
    } = useQuery(['circle-owner-leaderboard'], () => getLeaderboard(User_Details.id))
