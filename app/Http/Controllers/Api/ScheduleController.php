...
class ScheduleController extends ApiController
{
    ...
    public function show(Request $request, $schedule)
    {
        ...
        $resources = [
            ...
            "videos" => VideoResource::collection($videos->orderBy('order', 'asc')->get())
        ];
    ...
    function setViewers(Request $request, $id)
    {
        ...
        $attendant = LiveAttendants::where('user_id', $user->id)->where('schedule_id', $schdule->id)->where('date', date("Y-m-d"))->first();
