<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasSignal">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">
            <span v-if="!edit">Create</span><span v-else>Update</span> Course
        </h5>
        ...
        <form>
            ...
            <div class="col-lg-12 mb-3">
                ...
                <div class="d-flex justify-content-center mb-3">
                    <svg v-if="!photo_preview" width="41" height="200" viewbox="0 0 41 40"
            ...
            <div v-if="edit">
                <button :disabled="loading" @click.prevent="update(academyId)" class="btn btn-primary me-1">
