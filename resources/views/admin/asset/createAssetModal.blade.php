<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasSignal">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Create Asset</h5>
        ...
        <div class="container-fluid">
            <form>
                <div class="row">
                    ...
                    <div class="col-xl-12 mb-3">
                        <label for="exampleFormControlInput3" class="form-label">Asset Name<span
                                class="text-danger">*</span></label>
                        <input type="text" v-model="asset_name" class="form-control" id="exampleFormControlInput3"
                            placeholder="">
                        <span v-if="errors?.asset_name" class="text-danger">@{{ errors?.asset_name[0] }}</span>
                    </div>
                    <div class="col-xl-12 mb-3">
                        <label for="exampleFormControlInput3" class="form-label">Asset Symbol<span
                                class="text-danger">*</span></label>
                        <input type="text" v-model="symbol" class="form-control" id="exampleFormControlInput3"
                            placeholder="">
                        <span v-if="errors?.symbol" class="text-danger">@{{ errors?.symbol[0] }}</span>
                    </div>
                    <div class="col-lg-12 mb-3">
                        ...
                        <input class="form-control form-control-sm" ref="fileInput" @change="handlePhotoUpload($event)" id="formFileSm"
                            type="file">
                ...
                <div v-if="edit">
                    <button :disabled="loading" @click.prevent="update(assetId)" class="btn btn-primary me-1">
