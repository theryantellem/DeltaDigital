            ...
            <form>
                <div class="row">
                    <div class="col-xl-12 mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Asset Type<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" v-model="asset_type" id="exampleFormControlInput1"
                            placeholder="">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            ...
                            <img v-else :src="photo_preview" alt="Chart Preview" style="max-width: 100%; max-height: 200px; height: 200px">
                        </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            <svg v-if="!chart_photo_preview" width="41" height="200" viewbox="0 0 41 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M27.1666 26.6667L20.4999 20L13.8333 26.6667" stroke="#DADADA"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M20.5 20V35" stroke="#DADADA" stroke-width="2" stroke-linecap="round"
                            ...
                            <img v-else :src="chart_photo_preview" alt="Chart Preview" style="max-width: 100%; max-height: 200px; height: 200px">
                        </div>
