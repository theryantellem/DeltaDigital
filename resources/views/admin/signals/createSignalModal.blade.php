            ...
            <form>
                <div class="row">
                    <div class="col-xl-12 mb-3">
                        ...
                        <select v-model="category" class="form-control" @change="filterAsset()" id="categorySelect">
                            <option value="">--select--category--</option>
                            <option v-for="(category,index) in categories" :key="index"
                                :value="category?.category?.id" :data-type="category?.category?.type">
                                <span class="text-capitalize"> @{{ category?.category?.name }}</span>
                            </option>
                        </select>
                        <span v-if="errors?.category" class="text-danger">@{{ errors?.category[0] }}</span>
                    </div>
                    <div v-if="type === 'trade'" class="row">
                        <div class="col-xl-12 mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Asset<span
                                    class="text-danger">*</span></label>
                            <select v-model="asset_type" class="form-control" id="assetsSelect">
                ...
                <div v-if="type">
                    <div class="col-lg-12 mb-3">
                        <label v-if="type == 'trade'">Chart Photo</label>
                        <label v-if="type == 'news'">Photo</label>
                        ...
                        <input class="form-control form-control-sm" ref="fileInput"
                            @change="handleChartPhotoUpload($event)" id="formFileSm" type="file">
