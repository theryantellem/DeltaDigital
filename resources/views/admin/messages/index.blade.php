                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-5 chat-border mobile-chat chat-left-area">
                        <div class="people-list dz-scroll">
                            <div class="chat-p style-1" v-for="(follower, index) in followers" :key="index">
                                <div class="d-flex">
                                    <img :src="follower?.user?.profile_picture || '{{ asset('assets/images/ultimate_avatar.webp') }}'" class="avatar avatar-lg rounded-circle" alt="" />
                                    <div class="ms-2">
                            ...
                            <template v-for="(message, index) in reversedMessages" :key="message.id">
                                ...
                                <div :class="getMessageClasses(message)">
                                    <div v-if="message.sender.id === educator" class="message-sent w-auto">
                                        <a :href="message?.message" data-lightbox="profile" class="chat-meadia" v-if="message?.type === 'media'">
                        ...
                        <div class="message-send style-2">
                            <div class="type-massage style-1">
                                <div class="input-group">
                                    <textarea rows="1" v-model="message" @keyup.enter="sendMessage" class="form-control" placeholder="Enter Text Here ..."></textarea>
                                </div>
                            </div>
                            <div class="right-content">
                                <button type="button" class="btn btn-primary p-2" :disabled="loading" @click.prevent="sendMessage">
                                ...
                                <button type="button" class="btn btn-primary p-2" :disabled="loading" @click.prevent="openFileInput">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center mb-3">
                        <svg v-if="!photo_preview" width="41" height="200" viewbox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a v-else :href="photo_preview" data-lightbox="profile">
                            <img :src="photo_preview" alt="Media Preview" style="max-width: 100%; max-height: 200px; height: 200px">
                        </a>
                    </div>
