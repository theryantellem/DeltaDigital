                            ...
                            <div class="chat-p shaprate">
                                ...
                                <div class="icon-box bg-primary-light">
                                    <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <ellipse cx="10.1459" cy="9.90749" rx="2.1968" ry="2.1968" stroke="var(--primary)" stroke-linecap="round" stroke-linejoin="round"></ellipse>
                                    </svg>
                                </div>
                            </div>
                            <div class="c-list">
                                <div class="input-group search-area">
                                    ...
                                    <svg width="18" height="19" viewbox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="8.82495" cy="9.32491" r="6.74142" stroke="#0D99FF" stroke-linecap="round" stroke-linejoin="round"></circle>
                                        <path d="M13.5137 14.3638L16.1568 16.9999" stroke="#0D99FF" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    </a></span>
                                </div>
                            </div>
                            <div class="people-list dz-scroll">
                                ...
                                <div class="chat-p style-1">
                                    <div class="d-flex active">
                                        <img src="images/contacts/d4.jpg" class="avatar avatar-lg  rounded-circle" alt="">
                                        <div class="ms-2">
                                ...
                                <div class="chat-p style-1">
                                    <div class="d-flex">
                                        <img src="images/contacts/d2.jpg" class="avatar avatar-lg  rounded-circle" alt="">
                                        <div class="ms-2">
