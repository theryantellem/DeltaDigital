<div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasSignal">
    <div class="offcanvas-header">
        <h5 class="modal-title" id="#gridSystemModal">Create Educator</h5>
            ...
            <form>
                <div class="row">
                    ...
                    <div class="col-xl-12 mb-3">
                            ...
                            <div class="row">
                                <div v-for="role in roleList" :key="role.id"
                                    ...
                                    <div class="form-check custom-checkbox mb-3">
                                        <input type="checkbox" class="form-check-input" v-model="roles"
                                            id="customCheckBox1" :value="role?.id">
                        ...
                        <span v-if="errors.roles" class="text-danger">@{{ errors?.roles[0] }}</span>
                    </div>
                ...
                <div v-if="edit">
                    <button :disabled="loading" @click.prevent="update(adminId)" class="btn btn-primary me-1">
