            ...
            <form>
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        <svg v-if="!thumbnail_preview" width="41" height="200" viewbox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <img v-else :src="thumbnail_preview" alt="Thumbnail Preview" style="max-width: 100%; max-height: 200px; height: 200px">
                    </div>
                    <input class="form-control form-control-sm" ref="fileInput" @change="handleThumbnailUpload($event)" id="formFileSm" type="file">
                    <span v-if="errors.thumbnail" class="text-danger">@{{ errors.thumbnail[0] }}</span>
                </div>

                <div class="mb-3">
                    <label>Video File</label>
                    <input class="form-control form-control-sm" ref="fileInput" @change="handleFileChange($event)" id="formFileSm" type="file">
