...
<head>
    ...
    <!-- Page Title -->
    <title>Delta Finix - Delta Digital LLC</title>
    ...
    <link rel="icon" href="{{ asset('frontend/img/favicon/fav.jpg') }}" sizes="any" />
    ...
    <meta property="og:image" content="{{ asset('frontend/img/favicon/og-image.jpg') }}" />
    <!-- Facebook Metadata End -->

    <!-- Template Styles Start -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/css/loaders/loader.css') }}" />
...
<body>
    ...
    <header id="header" class="header">
        ...
        <div class="header__logo">
            <img src="{{ asset('frontend/img/cyborlog.png') }}" width="10%" alt="DeltaDigitalPro" />
        </div>
        <!-- Logo End -->
                        ...
                        <div class="header__buttons d-flex justify-content-end align-items-center">
                            ...
                            <div class="socials-desktop">
                                ...
                                <ul class="socials d-flex align-items-start">
                                    <li>
                                        <a class="btn btn-s-text"
                                            href="https://web.facebook.com/deltadigitalpro?_rdc=1&_rdr" target="_blank">
                                    ...
                                    <li>
                                        <a class="btn btn-s-text"
                                            href="https://www.instagram.com/deltadigitalpro?igshid=YmMyMTA2M2Y%3D"
                                            target="_blank">
                                    ...
                                    <li>
                                        <a class="btn btn-s-text" href="https://t.me/DeltaDigitalPro" target="_blank">
                                            <span class="btn-title">Telegram</span>
                                            <span class="btn-hover">Telegram</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <a class="btn btn-s btn-s-icon" href="https://discord.com/invite/MzWgyEnb">
                                <span class="btn__background dark"></span>
                                <span class="btn__text light">
                                    <i class="fa-solid fa-bell"></i>
                                    <em class="btn-title">Discord</em>
                                    <em class="btn-hover">Discord</em>
                                </span>
                            </a>
                            <!-- Notify Trigger End -->
                        </div>
                                            ...
                                            <ul class="navigation">
                                                ...
                                                <li>
                                                    <a href="https://www.deltadigital.pro/en/user/ng/delta/page/terms-conditions"
                                                        ...
                                                        <span class="nav-star"></span>
                                                        <span class="nav-caption">Term of Use</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://www.deltadigital.pro/en/user/ng/delta/page/privacy-policy"
                                                        class="navigation__link">
                                                        <span class="nav-star"></span>
                                                        <span class="nav-caption">Privacy Policy</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://www.deltadigital.pro/en/user/ng/delta/page/contact-us-highlight"
                                                        class="navigation__link">
                                                        <span class="nav-star"></span>
                                ...
                                <div class="container-fluid px-0">
                                    <div class="row gx-0 gx-lg-5">
                                        <div class="col-12 col-lg-4 menudata__item">
                                            ...
                                            <p class="menudata__text">
                                                <a class="contact-link"
                                                    href="mailto:support@deltadigital.pro">support@deltadigital.pro</a>
                                            </p>
                                        </div>
                                        <div class="col-12 col-lg-8 menudata__item">
                                            ...
                                            <p class="menudata__text">
                                                <a class="contact-link"
                                                    href="https://maps.app.goo.gl/HPwNyaoT5LLXFCyf9">3343 Peachtree Rd
                                                    NE Ste 145-688 Atlanta, GA 30326</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="intro__content">
                            ...
                            <div id="headline" class="headline">
                                <h1 class="headline__title">
                                    OWN THE <br />FUTURE<br />Delta Digital
                                </h1>
