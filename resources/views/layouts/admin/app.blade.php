...
<head>
    ...
    <link href="{{ asset('assets/vendor/swiper/css/swiper-bundle.min.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/css/noUiSlider/14.6.4/nouislider.min.css') }}">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        @include('layouts.admin.partails._header')

        @include('layouts.admin.partails._sidebar')
